...
import { forwardRef, useImperativeHandle, useEffect, useRef, useMemo, FC, ReactNode, Suspense } from 'react';
...
const CanvasWrapper: FC<{ children: ReactNode }> = ({ children }) => (
  <Canvas dpr={[1, 2]} frameloop="always" className="w-full h-full relative" style={{ background: '#000000' }}>
...
const Beams: FC<BeamsProps> = ({
  ...
  return (
    <CanvasWrapper>
      ...
      <ThreeColor attach="background" args={['#000000']} />
