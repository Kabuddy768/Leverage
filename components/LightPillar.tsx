...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      // Fix: Removed reference to THREE.Precision as it is not exported from the THREE namespace.
      // The precision property directly accepts the quality string.
  ...
  if (!webGLSupported) {
    return <div className={`w-full h-full absolute top-0 left-0 flex items-center justify-center bg-black/10 text-gray-500 text-sm ${className}`} style={{ mixBlendMode }}>WebGL not supported</div>;
  }
