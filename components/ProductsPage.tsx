      ...
      <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-6 auto-rows-[280px]">
        {PRODUCTS_LIST.map((product, idx) => {
          ...
          return (
            <div 
              key={product.id}
              className={`group relative overflow-hidden rounded-[2.5rem] border border-white/5 bg-zinc-900/40 p-8 backdrop-blur-xl transition-all duration-500 hover:border-white/20 flex flex-col justify-between ${colSpan}`}
            >
